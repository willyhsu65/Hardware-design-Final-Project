...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xpm -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot KeyboardCtrl_0 xil_defaultlib.KeyboardCtrl_0 xil_defaultlib.glbl -log elaborate.log
}
