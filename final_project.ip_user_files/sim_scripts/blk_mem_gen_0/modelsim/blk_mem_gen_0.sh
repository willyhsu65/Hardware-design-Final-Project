...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/VivoBook/Downloads/Hardware-design-Final-Project-main/Hardware-design-Final-Project-main/final_project.cache/compile_simlib/modelsim"
  fi
